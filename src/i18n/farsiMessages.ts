let farsiMessages = {
    ra: {
        ...
        message: {
            ...
            bulk_delete_content: 'آیا از حذف  %{name} اطمینان دارید؟ |||| آیا از حدف %{smart_count} عدد از آیتم‌ها اطمینان دارید؟',
        ...
        notification: {
            ...
            updated: 'آیتم بروز‌رسانی شد',
            created: 'آیتم ایجاد شد',
            deleted: 'آیتم حذف شد',
            bad_item: 'آیتم اشتباه',
            item_doesnt_exist: 'آیتم پیدا نشد',
